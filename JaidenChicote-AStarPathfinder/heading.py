from notebook import psource, show_graph, final_path_colors, display_visual
...
def display( defined_problem, select_algorithm):
    iterations, node = select_algorithm(defined_problem)
    print (' Iteration times : {}'.format(iterations) + '  Path : {}'.format(node.path()))

def display_for_graph(defined_problem, select_algorithm, graph_data):
    all_node_colors = []
